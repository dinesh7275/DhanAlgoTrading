...
class ConfigManager:
    ...
    def import_config(self, filepath):
        ...
        try:
            ...
            print(f"Trading Capital: Rs.{imported_config.get('trading', {}).get('initial_capital', 0):,}")
    ...
    def print_config_summary(self):
        ...
        print(f" Initial Capital: Rs.{trading.get('initial_capital', 0):,}")
...
def _update_trading_params(config_manager):
    ...
    new_capital = input(f"Initial Capital (current: Rs.{current_capital:,}): ").strip()
    if new_capital:
        try:
